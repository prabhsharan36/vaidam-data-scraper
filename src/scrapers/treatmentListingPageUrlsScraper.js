...
const fetchDepartmentLinks = require("./departmentListingPageUrls")
async function treatmentListingPageUrls(baseCountryListingUrl = 'https://www.vaidam.com/hospitals/turkey') {
